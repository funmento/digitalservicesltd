...
export default function AdminPage() {
  return <ProtectedPage><AppShell section="Admin"><div className="dashboard admin-page">
    ...
    <div className="admin-grid">
      ...
      <section><div className="card-heading"><div><h2>Active modules</h2><p>4 modules · £115/month</p></div><button className="view-all">Marketplace <ChevronRight /></button></div>{['CRM', 'Inventory', 'Purchasing', 'Projects'].map((module, index) => <div className="active-module" key={module}><span><Check /></span><b>{module}</b><em>£{[29, 35, 24, 27][index]}/mo</em></div>)}<button className="add-module"><Plus />Add another module</button></section>
    </div>
